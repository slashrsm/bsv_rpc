defmodule BsvRpc.PublicKeyTest do
  ...
  test "compressed public key" do
    ...
    assert %BsvRpc.PublicKey{
             compressed: true,
             key:
               <<2, 161, 99, 60, 175, 204, 1, 235, 251, 109, 120, 227, 159, 104, 122, 31, 9, 149,
  ...
  test "uncompressed public key" do
    ...
    assert %BsvRpc.PublicKey{
             compressed: false,
             key:
               <<4, 31, 240, 254, 15, 123, 21, 255, 170, 133, 255, 159, 71, 68, 213, 57, 19, 156,
                 37, 42, 73, 113, 15, 176, 83, 187, 159, 43, 147, 49, 115, 255, 154, 123, 170,
                 212, 29, 4, 81, 71, 81, 230, 133, 31, 83, 4, 253, 36, 55, 81, 112, 59, 237, 33,
                 185, 20, 246, 190, 33, 140, 15, 163, 84, 163, 65>>
           } == key
  end
